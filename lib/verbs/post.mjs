...
export async function Post(req, res, jnode) {
    ...
    for await (const chunk of req.readableWebStream()) {
        ...
        // TODO: Build blocks out of chunks (chunks won't be the
        // same size as blocks because that would be too easy).
        // This code cheats for now.
        ...
        // Add the hash of each block to the jnode.
